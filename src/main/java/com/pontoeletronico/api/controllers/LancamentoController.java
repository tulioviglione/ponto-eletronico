...
import com.pontoeletronico.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	//quantidade de registros retornados. Configurado em application.properties
	 ...
	 * 
	 * @param funcionarioId (id do funcionario para buscar lançamentos)
	 * @param pag (pagina que será pesquisada. paginação realizada por qtdPorPagina)
	 * @param ord (campo utilizado para ordenação)
	 * @param dir (tipo de ordenação)
