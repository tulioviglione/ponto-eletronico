...
VALUES (NULL, '17826608000172', CURRENT_DATE(), CURRENT_DATE(), 'Admin TI');
...
VALUES (NULL, '36524005007', CURRENT_DATE(), CURRENT_DATE(), 'admin@admin.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
